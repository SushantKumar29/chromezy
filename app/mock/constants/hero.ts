...
export const HERO_CONTENT = {
  badge: {
    icon: "mdi-magic.svg",
    text: "Introducing AI Automation",
  },
  title: {
    from: { prefix: "from", text: "CONCEPT", color: "#11DEFF" },
    to: { prefix: "to", text: "REALITY", color: "#4380FF" },
  },
  subtitle: "We Engineer your Software Success & Digital Transformation.",
  description:
